...
- **Status:** **POLISH** · ✅ **P8.6** (empty-state card + `BeaconBanner` + `BeaconIdentityBlock`; owner-mode chrome still deferred — open question #1)
...
- **Android:** equivalent
- **Status:** **POLISH** · ✅ **P8.6** (empty-state card + `BeaconBanner(.home)` + `BeaconIdentityBlock`)
