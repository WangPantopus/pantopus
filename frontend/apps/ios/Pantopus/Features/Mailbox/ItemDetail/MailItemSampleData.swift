...
public extension MailItemSampleData {
    ...
    /// the same as the design hand-off until the backend ingests
    /// real personal invites.
    static let partyInvite = PartyDetailDTO(
        ...
        attendees: [
            ...
            PartyAttendee(id: "derek", name: "Derek", initials: "DR", accent: .warning, plusCount: 1, status: .going),
            ...
            PartyAttendee(id: "aliyah", name: "Aliyah", initials: "AW", accent: .home, plusCount: 0, status: .going)
        ],
        bringList: [
    ...
    /// A17.9 secondary "you're going" state — the user RSVPed Going with
    /// a +1, claimed the bottle, and the green confirmation banner is
    /// stamped in.
