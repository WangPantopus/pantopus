                ...
                ForEach(PostGigV1PriceType.allCases) { type in
                    Button {
                        ...
                        HStack(spacing: Spacing.s2) {
                            ZStack {
                                Circle()
                                    .stroke(type == selected ? Theme.Color.primary600 : Theme.Color.appBorderStrong, lineWidth: type == selected ? 5 : 1.5)
...
private struct PostGigV1ErrorBanner: View {
...
private struct PostGigV1InlineError: View {
    let message: String
...
private struct PostGigV1FieldLabel: View {
    let title: String
    let required: Bool
...
private struct PostGigV1LegacyStamp: View {
    var body: some View {
        HStack(spacing: Spacing.s1) {
...
private struct PostGigV1LoadingView: View {
    var body: some View {
...
private struct PostGigV1EmptyView: View {
    let onStart: () -> Void
...
private struct PostGigV1FatalErrorView: View {
    let message: String
    let onRetry: () -> Void
