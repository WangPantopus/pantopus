 ...
 */
@Singleton
class Observability @Inject constructor() {
    ...
    fun capture(message: String, level: SentryLevel = SentryLevel.WARNING) {
...
private fun SentryLevel.toTimberPriority(): Int = when (this) {
