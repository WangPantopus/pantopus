        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "me-in-1", MailItemCategory.Package,
                            ...
                            "Amazon Logistics", minutesAgo = 12, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "me-in-2", MailItemCategory.Certified,
                            ...
                            "City of Oakland · Planning", minutesAgo = 60, viewed = false, trust = MailTrust.Verified,
                        ),
                    ),
            ),
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "me-in-3", MailItemCategory.Coupon,
                            ...
                            "4th & Market Bakery", minutesAgo = 60 * 24, viewed = true, trust = MailTrust.Partial,
                        ),
                        mail(
                            "me-in-4", MailItemCategory.Community,
                            ...
                            "Elm Park HOA", minutesAgo = 60 * 26, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "me-in-5", MailItemCategory.Booklet,
                            "June primary voter guide — 28 pages",
                            "Candidate questionnaires, ballot measure breakdowns, and a polling place lookup.",
                            "League of Women Voters", minutesAgo = 60 * 48, viewed = true, trust = MailTrust.Verified,
                        ),
                    ),
            ),
        )
        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "me-co-1", MailItemCategory.Bill,
                            "Water bill — $58.20 due May 28",
                            "Autopay is off for this account. Pay before the due date to avoid a late fee.",
                            "EBMUD", minutesAgo = 120, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "me-co-2", MailItemCategory.Membership,
                            "Renew your library card",
                            "Your card expires May 31. Renew online in two minutes to keep your holds active.",
                            "Oakland Public Library", minutesAgo = 60 * 30, viewed = false, trust = MailTrust.Verified,
                        ),
                    ),
            ),
        )
        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "me-va-1", MailItemCategory.Certified,
                            "Lease — 412 Elm St (signed)",
                            "Fully executed copy of your 12-month residential lease. Stored for your records.",
                            "Cornerstone Realty", minutesAgo = 60 * 24 * 9, viewed = true, trust = MailTrust.Verified,
                        ),
                        mail(
                            "me-va-2", MailItemCategory.Statement,
                            "2025 tax summary",
                            "Year-end summary of the income documents connected to your account.",
                            "Pantopus", minutesAgo = 60 * 24 * 14, viewed = true, trust = MailTrust.Chain,
                        ),
                    ),
            ),
        )
        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "home-in-1", MailItemCategory.Community,
                            "Building water shutoff Thursday 9am–12pm",
                            "Maintenance will flush the risers. Store water ahead of time.",
                            "Maple Court HOA", minutesAgo = 90, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "home-in-2", MailItemCategory.Package,
                            "Dishwasher part out for delivery",
                            "Replacement rack arriving today. Signature not required.",
                            "PartSelect", minutesAgo = 150, viewed = false, trust = MailTrust.Verified,
                        ),
                    ),
            ),
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "home-in-3", MailItemCategory.Notice,
                            "Annual fire inspection scheduled",
                            "The inspector will need access to all units June 10. Reply to confirm.",
                            "City Fire Marshal", minutesAgo = 60 * 40, viewed = true, trust = MailTrust.Verified,
                        ),
                    ),
            ),
        )
        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "home-co-1", MailItemCategory.Bill,
                            "HOA dues — $310 due June 1",
                            "Quarterly dues for Maple Court. Pay online or by check.",
                            "Maple Court HOA", minutesAgo = 200, viewed = false, trust = MailTrust.Verified,
                        ),
                    ),
            ),
        )
        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "biz-in-1", MailItemCategory.Delivery,
                            "Linen order delivered to back entrance",
                            "24 tablecloths and 96 napkins signed for by staff.",
                            "Riverside Linen Supply", minutesAgo = 100, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "biz-in-2", MailItemCategory.Subscription,
                            "POS software renews June 15",
                            "Your annual plan renews automatically. Review your seat count before then.",
                            "SquareUp", minutesAgo = 60 * 33, viewed = true, trust = MailTrust.Partial,
                        ),
                    ),
            ),
        )
                ...
                items =
                    listOf(
                        mail(
                            ...
                            "CA Dept of Tax & Fee Admin", minutesAgo = 60 * 48, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "biz-co-2", MailItemCategory.Statement,
                            "Statement of Information (SI-100) renewal",
                            "Annual filing to keep Pantopus Bakery Co LLC in good standing. $25 filing fee.",
                            "CA Secretary of State", minutesAgo = 60 * 120, viewed = false, trust = MailTrust.Verified,
                        ),
                    ),
            ),
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "biz-co-3", MailItemCategory.Legal,
                            "Lease addendum — 1248 Oak Ave, suite 2",
                            "Mariah Chen requests your signature on Rider 3. Two signature fields and one initial.",
                            "Cornerstone Realty · via DocuSign", minutesAgo = 180, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "biz-co-4", MailItemCategory.Bill,
                            "Invoice 4821 — $642.50 net 30",
                            "Auto-pay is disabled for this vendor. Confirm before May 28 to keep your 2% on-time discount.",
                            "Riverside Linen Supply", minutesAgo = 300, viewed = false, trust = MailTrust.Verified,
                        ),
                        mail(
                            "biz-co-5", MailItemCategory.Subscription,
                            ...
                            "Verizon Business", minutesAgo = 60 * 24, viewed = true, trust = MailTrust.Partial,
                        ),
                    ),
            ),
        )
        ...
        listOf(
            MailboxSampleSection(
                ...
                items =
                    listOf(
                        mail(
                            "biz-va-1", MailItemCategory.Statement,
                            "2025 profit & loss",
                            "Year-end P&L exported from your connected accounts.",
                            "Pantopus", minutesAgo = 60 * 24 * 15, viewed = true, trust = MailTrust.Chain,
                        ),
                    ),
            ),
        )
